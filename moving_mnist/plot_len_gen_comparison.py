...
def main():
    ...
    ap.add_argument("--strip_cols", type=int, default=8, help="Number of frame columns in the strip")
    ...
    if args.strip:
        ...
        fig = plt.figure(figsize=(3.2 + 0.75 * args.strip_cols + 4.4, fig_h))
        gs = GridSpec(1, 2, width_ratios=[0.75 * args.strip_cols, 4.4],
                      wspace=0.14, figure=fig)
        strip_gs = gs[0].subgridspec(strip_rows, args.strip_cols,
